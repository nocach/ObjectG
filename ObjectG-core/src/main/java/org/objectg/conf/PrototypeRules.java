...
public class PrototypeRules {
	 ...
	 * @param value set exactly this value
	 */
	public static byte valueByte(byte value) {
	 ...
	 * @param value set exactly this value
	 */
	public static boolean valueBoolean(boolean value) {
		PrototypeConfiguration.setPlannedRule(Rules.sequence(value));
		return false;
	}
	 ...
	 * @param value set exactly this value
	 */
	public static char valueChar(char value) {
		PrototypeConfiguration.setPlannedRule(Rules.sequence(value));
		return 0;
	}
	 ...
	 * @param value set exactly this value
	 */
	public static short valueShort(short value) {
		PrototypeConfiguration.setPlannedRule(Rules.sequence(value));
		return 0;
	}
	 ...
	 * @param value set exactly this value
	 */
	public static int valueInt(int value) {
		PrototypeConfiguration.setPlannedRule(Rules.sequence(value));
		return 0;
	}
	 ...
	 * @param value set exactly this value
	 */
	public static long valueLong(long value) {
		PrototypeConfiguration.setPlannedRule(Rules.sequence(value));
		return 0;
	}
	 ...
	 * @param value set exactly this value
	 */
	public static float valueFloat(float value) {
		PrototypeConfiguration.setPlannedRule(Rules.sequence(value));
		return 0;
	}
	 ...
	 * @param value set exactly this value
	 */
	public static double valueDouble(double value) {
		PrototypeConfiguration.setPlannedRule(Rules.sequence(value));
		return 0;
	}
	 ...
	 *               from the sequence. If the last value is reached then next values will be generated from the start.
	 */
	public static boolean sequenceBoolean(boolean... values) {
		PrototypeConfiguration.setPlannedRule(Rules.sequence(values));
		return false;
	}
	 ...
	 *               from the sequence. If the last value is reached then next values will be generated from the start.
	 */
	public static byte sequenceByte(byte... values) {
		PrototypeConfiguration.setPlannedRule(Rules.sequence(values));
		return 0;
	}
	 ...
	 *               from the sequence. If the last value is reached then next values will be generated from the start.
	 */
	public static char sequenceChar(char... values) {
		PrototypeConfiguration.setPlannedRule(Rules.sequence(values));
		return 0;
	}
	 ...
	 *               from the sequence. If the last value is reached then next values will be generated from the start.
	 */
	public static short sequenceShort(short... values) {
		PrototypeConfiguration.setPlannedRule(Rules.sequence(values));
		return 0;
	}
	 ...
	 *               from the sequence. If the last value is reached then next values will be generated from the start.
	 */
	public static int sequenceInt(int... values) {
		PrototypeConfiguration.setPlannedRule(Rules.sequence(values));
		return 0;
	}
	 ...
	 *               from the sequence. If the last value is reached then next values will be generated from the start.
	 */
	public static long sequenceLong(long... values) {
		PrototypeConfiguration.setPlannedRule(Rules.sequence(values));
		return 0L;
	}
	 ...
	 *               from the sequence. If the last value is reached then next values will be generated from the start.
	 */
	public static float sequenceFloat(float... values) {
		PrototypeConfiguration.setPlannedRule(Rules.sequence(values));
		return 0f;
	}
	 ...
	 *               from the sequence. If the last value is reached then next values will be generated from the start.
	 */
	public static double sequenceDouble(double... values) {
		PrototypeConfiguration.setPlannedRule(Rules.sequence(values));
		return 0.;
	}
