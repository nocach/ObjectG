...
public class GenerationContext<T> {
	...
	private Type genericInformation;
	...
	public <U> GenerationContext<U> push(Class<U> clazz, Object parentObject) {
		...
		newContext.depthOffset = this.depthOffset;
		return newContext;
	}
	...
	private String getSafeParentObjectString() {
		...
		try {
			...
			return " parentObject.toString threw exception, parentObject.class=" + parentObject.getClass()
					.getSimpleName();
		}
	}
	...
	public int getGenerationDepth() {
		...
		return hierarchy.size() + depthOffset;
	}

	public void increaseDepthIgnoreByOne() {
		depthOffset--;
	}
	...
	public Type getGenericInformation() {
		return genericInformation;
	}

	public void setGenericInformation(final Type genericInformation) {
