...
class JpaRule extends GenerationRule<Object> {
	...
	private boolean isContextForExpectedProperty(GenerationContext context, Class expectedClass,
			String expectedProperty) {
		boolean matchedGeneratingField = context.getPropertyAccessor() != null && context.getPropertyAccessor()
				.getName().equals(expectedProperty);
