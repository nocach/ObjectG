...
public class FromListGenerationRuleTest extends BaseObjectGTest {
	...
	public void canGenerateByRule() {
		...
		String generatedString = listGenerationRule
				.getValue(new GenerationConfiguration(), GenerationContext.createRoot(String.class));
	...
	public void valuesGeneratedAreCyclic() {
		...
		assertEquals(1, listGenerationRule
				.getValue(new GenerationConfiguration(), GenerationContext.createRoot(Integer.class)));
		assertEquals(2, listGenerationRule
				.getValue(new GenerationConfiguration(), GenerationContext.createRoot(Integer.class)));
		assertEquals(1, listGenerationRule
				.getValue(new GenerationConfiguration(), GenerationContext.createRoot(Integer.class)));
	}
